...
#pragma hdrstop		// {Wierdo} Weirdo thing with MUSE
...
SDL_StartSB(void)
{
	...
	if (test == 0xbb)
	{
		// Boost FM output levels to be {equivilent} equivalent with digitized output
...
SDL_StartSS(void)
{
	...
	ssOn = 0x04;
	if (ssIsTandy)
		ssOff = 0x0e;				// Tandy {wierdness} weirdness
	else
...
///////////////////////////////////////////////////////////////////////////
//
//	SD_Default() - Sets up the default {behaviour} behavior for the Sound Mgr whether
